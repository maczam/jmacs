package info.hexin.jmacs.dao.query.pager;
...
public class Pager implements Serializable {
    private static final long serialVersionUID = -8569020762921831991L;
    ...
    public Pager setPageNumber(int pn) {
        if (1 > pn && log.isInfoEnabled()) {
            log.info("PageNumber shall start at 1 ,but input is %d, that mean pager is disable", pn);
        }
        pageNumber = pn;
        return this;
    }
